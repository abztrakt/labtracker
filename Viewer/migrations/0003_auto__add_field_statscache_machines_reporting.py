...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StatsCache.machines_reporting'
        db.add_column('Viewer_statscache', 'machines_reporting', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StatsCache.machines_reporting'
        db.delete_column('Viewer_statscache', 'machines_reporting')
