...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MachineMap.key_xpos'
        db.add_column('Viewer_machinemap', 'key_xpos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'MachineMap.key_ypos'
        db.add_column('Viewer_machinemap', 'key_ypos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MachineMap.key_xpos'
        db.delete_column('Viewer_machinemap', 'key_xpos')

        # Deleting field 'MachineMap.key_ypos'
        db.delete_column('Viewer_machinemap', 'key_ypos')
