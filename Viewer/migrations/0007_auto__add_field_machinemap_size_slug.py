...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MachineMap_Size.slug'
        db.add_column('Viewer_machinemap_size', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=60, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MachineMap_Size.slug'
        db.delete_column('Viewer_machinemap_size', 'slug')
