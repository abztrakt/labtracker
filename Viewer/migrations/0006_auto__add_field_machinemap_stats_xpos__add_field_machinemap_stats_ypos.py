...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MachineMap.stats_xpos'
        db.add_column('Viewer_machinemap', 'stats_xpos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'MachineMap.stats_ypos'
        db.add_column('Viewer_machinemap', 'stats_ypos', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MachineMap.stats_xpos'
        db.delete_column('Viewer_machinemap', 'stats_xpos')

        # Deleting field 'MachineMap.stats_ypos'
        db.delete_column('Viewer_machinemap', 'stats_ypos')
    ...
    models = {
        ...
        'Viewer.machinemap': {
            ...
            'stats_xpos': ('django.db.models.fields.IntegerField', [], {}),
            'stats_ypos': ('django.db.models.fields.IntegerField', [], {}),
            'view': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['Viewer.ViewCore']", 'unique': 'True', 'primary_key': 'True'})
        },
