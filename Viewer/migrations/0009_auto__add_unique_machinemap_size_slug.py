...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'MachineMap_Size', fields ['slug']
        db.create_unique('Viewer_machinemap_size', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MachineMap_Size', fields ['slug']
        db.delete_unique('Viewer_machinemap_size', ['slug'])
