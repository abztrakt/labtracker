...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Location.usable_threshold'
        db.add_column('Machine_location', 'usable_threshold', self.gf('django.db.models.fields.IntegerField')(default=95), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.usable_threshold'
        db.delete_column('Machine_location', 'usable_threshold')
