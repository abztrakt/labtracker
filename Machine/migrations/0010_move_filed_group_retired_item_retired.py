...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        Loop through all items in Group "Retired", then change the items
        boolean field "retired" to true. Remove the Group 'Retired'.
        """
        try: 
            for i in orm.Group.objects.get(name='Retired').items.values():
                ...
                try:
                    retired = orm.Group.objects.get(name='Retired')
                    retired.delete()
                except ObjectDoesNotExist:
                    pass
        except ObjectDoesNotExist:
    ...
    def backwards(self, orm):
        """
        Create the new group 'Retired' if not already exist. Loop through the items
        and find the ones that boolean field 'retired' is true. Add them into group
        'Retired'.
        """
        try:
            retired = orm.Group.objects.get(name='Retired')
