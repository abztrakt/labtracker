...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.retired'
        db.add_column('Machine_item', 'retired', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Item.mac3'
        db.alter_column('Machine_item', 'mac3', self.gf('Machine.models.MacField')(max_length=17))

        # Changing field 'Item.mac2'
        db.alter_column('Machine_item', 'mac2', self.gf('Machine.models.MacField')(max_length=17))

        # Changing field 'Item.mac1'
        db.alter_column('Machine_item', 'mac1', self.gf('Machine.models.MacField')(max_length=17))


    def backwards(self, orm):
        
        # Deleting field 'Item.retired'
        db.delete_column('Machine_item', 'retired')
    ...
    models = {
        ...
        'Machine.item': {
            ...
            'mac1': ('Machine.models.MacField', [], {'max_length': '17'}),
            'mac2': ('Machine.models.MacField', [], {'max_length': '17', 'blank': 'True'}),
            'mac3': ('Machine.models.MacField', [], {'max_length': '17', 'blank': 'True'}),
