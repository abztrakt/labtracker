...
class Issue(models.Model):
    ...
    item = models.ForeignKey(Item, null=True, blank=True, verbose_name="Item Name")
    ...
    last_modified = models.DateTimeField(blank=True, default=datetime.now) #auto_now=True, null=True)
