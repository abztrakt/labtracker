...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Issue.steps'
        db.add_column('IssueTracker_issue', 'steps', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Issue.attempts'
        db.add_column('IssueTracker_issue', 'attempts', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Issue.steps'
        db.delete_column('IssueTracker_issue', 'steps')

        # Deleting field 'Issue.attempts'
        db.delete_column('IssueTracker_issue', 'attempts')
